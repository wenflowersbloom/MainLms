<?php
	if (isset($_POST["submit"])) {
		...
		if ($name == "" | $username =="" | $password =="" | $email == "" | $phone == "" | $lecturer == "" | $idno == "" | $address == "") {
			$error_m= "Error! <span>Field must not be empty</span>";
		}
        ...
        if(mysqli_num_rows($sql2_u) > 0){
            ...
            $error_id = "This id no already registered";
            ...
            if($insert){
                ...
                $message = "<a href='http://localhost:3307:3307/lms/Source/librarian/user/teacher/verify.php?vkey=$vkey'>Verify Email</a>";
                $headers = "From: josemariedevera24@gmail.com \r\n";
