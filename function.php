...
//            }
        ...
        elseif(mysqli_num_rows($sql_e) > 0){
            ...
            $error_reg = "This ID Number already registered";
            ...
            //     $message = "<a href='http://localhost:3307:3307/lms/Source/librarian/user/student/verify.php?vkey=$vkey'>Verify Email</a>";
