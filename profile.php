    ...
    <div class="dashboard-header">
        <div class="container">
            ...
            <div class="profile-content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="photo" height="300px" weight="300px">
                            <?php
                        ...
                        <div class="uploadPhoto">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="gap-30"></div>
                                <input type="submit" class="modal-mt btn btn-info" style="background-color:darkgreen;color:yellow;border-color:darkgreen;"value="Upload Image" name="submit">
                            </form>
                        </div>
                        <?php
                        ...
                        <div class="details">
                            ...
                            <form method="post">
                                ...
                                <div class="text-right mt-20">
                                    <input type="submit" style="background-color:darkgreen;color:white;border-color:darkgreen;" value="Save" class="btn btn-info" name="update">
                                </div>
                                <?php
